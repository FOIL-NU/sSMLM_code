...
root_path = 'D:\25-7-31 2C Troubleshooting';
...
for ii = 1:height(filenames)
    ...
    fname_zcali = fullfile(root_path,'axialcali.mat');
    ...
    if ~isfile(fname_out)
        ...
        [tsoutput, recon_im, corr] = processfile(fname0, fname1, 'odwp',...
            'order0_roi', [0, 0, 670, 362], ... 
            'order1_roi', [930, 0, 680, 362], ...
            'zcali_path', fname_zcali, ...
